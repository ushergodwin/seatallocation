    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            @if (session('account_type') == 'Student')
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                    <div class="sidebar-brand-icon rotate-n-15">
                        <img src="{{asset('img/undraw_profile.svg')}}" class="rounded-circle" height="50" alt="logo"/>
                    </div>
                    <div class="sidebar-brand-text mx-3"
                    data-intro="Hello {{ session('name') }}👋, welcome to the SCIT SEAT ALLOCATION" data-step="1" data-hint="Step 1">
                        {{ session('reg_no')}} <br/>
                        {{session('st_no')}}
                    </div>
                </a>
            @else 
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
                    <div class="sidebar-brand-icon rotate-n-15">
                        <img src="{{asset('imgs/icons/logo.png')}}" class="rounded-circle" height="50" alt="logo"/>
                    </div>
                    <div class="sidebar-brand-text mx-3"
                    data-intro="Hello {{ session('name') }}👋, welcome to the SCIT SEAT ALLOCATION" data-step="1" data-hint="Step 1">SCIT SEAT ALLOCATION</div>
                </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ url('dashboard') }}">
                    ...
                    <span>Dashboard ({{ session('account_type') }})</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('dashboard/students/list') }}">List All</a>
                        <a class="collapse-item" href="{{ url('dashboard/students/add') }}">Add New</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('dashboard/rooms/list') }}">List All</a>
                        <a class="collapse-item" href="{{ url('dashboard/rooms/add') }}">Add New</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('dashboard/exams/list') }}">List All</a>
                        @if (session('account_type') == 'Admin')
                            <a class="collapse-item" href="{{ url('dashboard/exams/add') }}">Add New</a>
                        @endif
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('dashboard/supervisors/list') }}">List All</a>
                        @if (session('account_type') == 'Admin')
                            <a class="collapse-item" href="{{ url('dashboard/supervisors/add') }}">Add New</a>
                        @endif
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="{{ url('dashboard/seats/allocation') }}"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                {{-- <span class="mr-2 d-none d-lg-inline text-gray-600 small text-warning">{{ $user->first_name . " " . $user->last_name }}</span> --}}
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="#">
                                    ...
                                    Hi, {{ session('name') }} <br/> ({{ session('account_type') }})
                                </a>
                                <a class="dropdown-item" href="{{ url('dashboard/user/settings') }}">
                                ...
                                <a class="dropdown-item" href="{{ url('api/auth/user/logout') }}" data-toggle="modal" data-target="#logoutModal">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SCIT SEAT ALLOCATION {{ date('Y') }}</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="{{ url('api/auth/user/logout') }}">Logout</a>
                </div>
            </div>
        </div>
    </div>
