    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-body">
                <form action="<?php echo e(url('dashboard/rooms/store')); ?>" method="POST" id="roomForm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\seatallocation\app\views/rooms/add.blade.php ENDPATH**/ ?>